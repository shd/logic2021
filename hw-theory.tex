...
(множеством всех открытых множеств) $\Omega\subseteq X$.
...
Покажите, что исчисление высказываний противоречиво тогда и только тогда, когда в нём доказуема любая формула. 
Доказательство должно быть корректным как для классического, так и для интуиционистского исчислений.
