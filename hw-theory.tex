...
\begin{enumerate}
\item не выполняется аксиома индукции;
\item без инъективности операции $(')$; обязательно ли в таком множестве $0$ единственен?
\item с выделенным элементом $0$, не имеющим свойства отсуствия предшественников (т.е. существует $x: x' = 0$);
\end{enumerate}
