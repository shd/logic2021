...
\item Рассмотрим теорию групп с добавленной аксиомой $\vdash \forall a.\forall b.a\cdot b = 1$. 
...
\item Определите теорию первого порядка, формализующую решётки. Докажите в ней закон поглощения: $\forall a.\forall b.a + a \cdot b = b$.
